...
function dres_image = read_dres_image_kitti(seq_folder_path, seq_name, seq_num, image_ext)
    ...
    for i = 1:seq_num
        filename = fullfile(seq_folder_path, 'image_02', seq_name, sprintf('%06d.%s', i-1, image_ext));
        disp(filename);
        I = imread(filename);
